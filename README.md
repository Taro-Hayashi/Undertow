...
### キット以外に必要なもの
![画像を添付](img/2_additional_required.jpg) 
|部品名|数|
|-|-|
...
![画像を添付](img/6_m2screws.jpg) 

支柱の保護フィルムをはがし、スペーサーをなべねじで止めます。  
![画像を添付](img/7_pillars_1.jpg) 

M3角ナットをスリットに立てます。
![画像を添付](img/8_pillars_2.jpg) 

支柱で挟み込み、M2ワッシャー、M2スプリングワッシャー、M2ナットの順に通して固定します。  
![画像を添付](img/9_pillars_3.jpg) 

すべての支柱を組み立てます。
![画像を添付](img/10_pillars_4.jpg) 
